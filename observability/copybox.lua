...
local function build()
  local win = WINDOW_MANAGER:CreateTopLevelWindow("VerditerCopyBoxWindow")
  ...
  win:SetHandler("OnMoveStop", function()
    if Verditer.SavedVars and Verditer.SavedVars.copybox then
      Verditer.SavedVars.copybox.x = win:GetLeft()
      Verditer.SavedVars.copybox.y = win:GetTop()
    end
  end)
  ...
  title:SetText("Verditer Debug Copy")
  ...
  local edit = CreateControlFromVirtual("VerditerCopyBoxEdit", ebbg, "ZO_DefaultEditMultiLineForBackdrop")
  ...
  local sv = Verditer.SavedVars and Verditer.SavedVars.copybox
